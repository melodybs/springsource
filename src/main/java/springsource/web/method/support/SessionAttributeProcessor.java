...
public class SessionAttributeProcessor implements 
	...
	public void handleReturnValue(Object returnValue, 
		...
		SessionAttribute annotation = 
				returnType.getMethodAnnotation(SessionAttribute.class);
		
		webRequest.setAttribute(
				annotation.value(), returnValue, WebRequest.SCOPE_SESSION);
	...
	public Object resolveArgument(MethodParameter parameter,
			...
			WebDataBinderFactory abinderFactory) throws Exception {
		...
		if (value == null && annotation.required()) {
			...
			throw new MissingServletRequestParameterException(
					annotation.value(), parameter.getParameterType().getName());
		}
